...
<script>
    ...
    function init_chart(force){
        ...
        if(chart_last_id_kabupaten==id_kabupaten && chart_last_id_kecamatan==id_kecamatan || force){
            return;
        }
        ...
        $.ajax({
            type: "get",
            url: site_url + '/pbi/penduduk/get_chart_column',
            data: {
    ...
    function show_chart_column(json){
        chart=$('#chart_container').highcharts({
            ...
            title: {
                text: 'Jumlah PBI Berdasarkan Lokasi'
            },
            subtitle: {
                text: json['title']
            },
