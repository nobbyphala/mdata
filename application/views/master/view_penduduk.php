        ...
        <div style="margin-top:10px;" class="mainbox col-lg-12">                    
            <div class="panel panel-info" >
                <div style="padding-top:10px" class="panel-body">
                    ...
                    <button type="button" class="btn btn-sm btn-primary ng-scope" onclick="window.location='<?=site_url()?>/master/penduduk/halaman_tambah'"><i class="fa fa-plus fa-fw"></i> Tambah Data</button>
                        ...
                        <div class="form-group col-lg-3">
                            <select class="form-control" id="select_kabupaten" name="select_kabupaten">
                                ...
                                foreach ($list_kabupaten as $key => $kabupaten) {
                                    echo '<option value="'.$kabupaten['id_kabupaten'].'">'.$kabupaten['kode_kabupaten'].' '.$kabupaten['nama_kabupaten'].'</option>';
                                }
                                ?>
                            </select>
                        </div>
...
<script>
    ...
    function kabupaten_berubah() {
        reqDataDropdown({
            ...
            'ret_array': ['id_kecamatan', 'kode_kecamatan', 'nama_kecamatan'],
            'selected_value': '',
    ...
    function initTabelPenduduk() {
        ...
        tabel_penduduk = $('#tabelPenduduk').dataTable({
            ...
            "createdRow": function (row, data, index) {
                ...
                html += '<li><a href="<?= site_url()?>/master/penduduk/edit_page?id_penduduk='+id+'"><i class="fa fa-refresh fa-fw"></i> Ubah</a></li>';
