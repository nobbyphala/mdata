            ...
            <div class="modal-body">
                <div class="page-tables">
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Kode Usia</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="kode_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Nama Usia</label>
                        <div class="col-lg-8">
...
<script>
    ...
    function init_datatable(){
        ...
        my_datatable = $('#my_datatable').dataTable({
            ...
            "ajax": {
                ...
                "url": site_url + "/master/usia/get_list_datatable",
    ...
    function hapus_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/usia/hapus',
            data: {
                id:$('#id_hapus').val()
            },
            success: function (data) {
    ...
    function tambah_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/usia/tambah',
            data: {
                kode:$('#kode_baru').val(),
                nama:$('#nama_baru').val(),
