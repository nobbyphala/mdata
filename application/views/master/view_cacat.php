                        ...
                        <div class="table-responsive" style="; min-height: 200px;">
                            <table id="my_datatable" cellpadding="0" cellspacing="1" border="0" width="100%" style="white-space: nowrap">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode Kecacatan</th>
                                        <th>Nama Kecacatan</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="modal-body">
                <div class="page-tables">
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Kode Kecacatan</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="kode_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Nama Kecacatan</label>
                        <div class="col-lg-8">
...
<script>
    ...
    function init_datatable(){
        ...
        my_datatable = $('#my_datatable').dataTable({
            ...
            "ajax": {
                ...
                "url": site_url + "/master/cacat/get_list_datatable",
    ...
    function simpan_perubahan(){
        $.ajax({
            type: "post",
            url: site_url + '/master/cacat/edit',
            data: {
                kode:$('#kode_edit').val(),
                nama:$('#nama_edit').val(),
                id:$('#id_edit').val()
    ...
    function hapus_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/cacat/hapus',
            data: {
                id:$('#id_hapus').val()
            },
            success: function (data) {
    ...
    function tambah_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/cacat/tambah',
            data: {
                kode:$('#kode_baru').val(),
                nama:$('#nama_baru').val()
            },
