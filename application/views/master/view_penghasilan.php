            ...
            <div class="modal-body">
                <div class="page-tables">
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Kode Penghasilan</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="kode_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Nama Nama Penghasilan</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="nama_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Batas Bawah</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="bawah_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Batas Atas</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="atas_edit"/>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="page-tables">
                    ...
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Nama Penghasilam</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Batas bawah</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="bawah_baru"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Batas Atas</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="atas_baru"/>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
...
<script>
    ...
    function init_datatable(){
        ...
        my_datatable = $('#my_datatable').dataTable({
            ...
            "ajax": {
                ...
                "url": site_url + "/master/penghasilan/get_list_datatable",
    ...
    function showEditDialog(id,index){
        ...
        $('#bawah_edit').val(data[3]);
        $('#atas_edit').val(data[4]);
        $('#id_edit').val(id);
    }
    ...
    function simpan_perubahan(){
        $.ajax({
            type: "post",
            url: site_url + '/master/penghasilan/edit',
            data: {
                kode:$('#kode_edit').val(),
                nama:$('#nama_edit').val(),
                id:$('#id_edit').val(),
                atas:$('#atas_edit').val(),
                bawah:$('#bawah_edit').val()
            },
    ...
    function hapus_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/penghasilan/hapus',
            data: {
                id:$('#id_hapus').val()
            },
            success: function (data) {
    ...
    function tambah_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/penghasilan/tambah',
            data: {
                kode:$('#kode_baru').val(),
                nama:$('#nama_baru').val(),
                bawah:$('#bawah_baru').val(),
                atas:$('#atas_baru').val(),
            },
            success: function (data) {
                if (data === 'ok') {
