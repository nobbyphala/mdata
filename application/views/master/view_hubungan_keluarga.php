            ...
            <div class="modal-body">
                <div class="page-tables">
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Kode Hubungan Keluarga</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" id="kode_edit"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                        <label class="col-lg-3 control-label">Nama Hubungan Keluarga</label>
                        <div class="col-lg-8">
...
<script>
    ...
    function init_datatable(){
        ...
        my_datatable = $('#my_datatable').dataTable({
            ...
            "ajax": {
                ...
                "url": site_url + "/master/hubungan_keluarga/get_list_datatable",
    ...
    function simpan_perubahan(){
        $.ajax({
            type: "post",
            url: site_url + '/master/hubungan_keluarga/edit',
            data: {
                kode:$('#kode_edit').val(),
                nama:$('#nama_edit').val(),
                id:$('#id_edit').val()
    ...
    function hapus_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/hubungan_keluarga/hapus',
            data: {
                id:$('#id_hapus').val()
            },
            success: function (data) {
    ...
    function tambah_data(){
        $.ajax({
            type: "post",
            url: site_url + '/master/hubungan_keluarga/tambah',
            data: {
                kode:$('#kode_baru').val(),
                nama:$('#nama_baru').val()
            },
