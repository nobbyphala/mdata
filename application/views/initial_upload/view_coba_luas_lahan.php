                ...
                <div style="padding-top:30px" class="panel-body">
                    ...
                    <div class="page-tables">
                        <div class="table-responsive" style="; min-height: 200px;overflow-x: auto">
                            <table id="" cellpadding="0" cellspacing="1" border="0" width="100%" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ID_KECAMATAN</th>
                                        <th>Kecamatan</th>
                                        <th>Penggunaan Lahan Pertanian</th>
                                        <th>Penggunaan Lahan Bukan Pertanian</th>
                                        <th>Jumlah</th>
                                        <th>Prosentase Lahan Pertanian</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php  
                                        ...
                                        {
                                            echo "<tr>";
                                                echo "<td><input type='checkbox' id='' name='no[]'/></td>";
                                                echo "<td>$val[1]</td>";
                                                echo "<td>$val[2]</td>";
                                                echo "<td>$val[3]</td>";
                                                echo "<td>$val[4]</td>";
