        ...
        <div style="margin-top:10px;" class="mainbox col-md-12">                    
            <div class="panel panel-info" >
                <div class="panel-heading" style="height: 50px; padding: 0px" >
                    <div class="panel-title col-md-6 text-center" style="height: 100%; margin: 0px; padding-top: 12px"><a href="<?= site_url() ?>/initial_upload">Upload Excel</a></div>
                ...
                <div style="padding-top:30px" class="panel-body">
                    ...
                    <div class="page-tables" id="div___" style="">
                        <button type="button" class="btn btn-danger" onclick="hapus_semua()">Hapus Semua</button>
                    </div>
                    <div class="clearfix"></div>
                    <div class="page-tables">
                        <div class="table-responsive" style="; min-height: 200px;overflow-x: auto">
                            <table id="tabelHasilUpload" cellpadding="0" cellspacing="1" border="0" width="100%" style="white-space: nowrap">
                                <thead>
                                    <tr>
