            ...
            <div class="panel panel-info" >
                <div style="padding-top:10px" class="panel-body">
                    <div class="page-tables" id="div_edit_penduduk_1" style="">
                        ...
                        <div class="form-group col-lg-3">
                            <select class="form-control" id="select_usia" name="select_usia">
                                <option value='0'>Semua Rentang Usia</option>
                                <?php
                                foreach ($list_usia as $key => $usia) {
                                    echo '<option value="'.$usia['KATEGORI_USIA_ID'].'">'.$usia['KATEGORI_USIA_NAMA'].'</option>';
                                }
                                ?>
                            </select>
                        </div>
...
<script>
    ...
    function init_chart(force){
        ...
        if(chart_last_id_kabupaten==id_kabupaten && chart_last_id_kecamatan==id_kecamatan && chart_last_id_usia==id_usia && last_id_desa==id_desa){
            return;
        }
        chart_last_id_provinsi=id_provinsi;
        chart_last_id_kabupaten=id_kabupaten;
        chart_last_id_kecamatan=id_kecamatan;
        chart_last_id_usia=id_usia;
        last_id_desa=id_desa;
        $.ajax({
            type: "get",
            url: site_url + '/pbi/usia/get_chart_column',
            data: {
                    id_usia:id_usia,
